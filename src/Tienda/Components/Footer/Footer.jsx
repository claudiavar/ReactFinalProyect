    ...
    <footer>
      ...
      <div className="main">
            ...
            <div className="d-md-flex m-2 flex-fill justify-content-">
              <div className="d-lg-flex flex-fill justify-content-evenly">
                <div className="text-lg-center py-lg-3 px-lg-4 me-2">
                  <div className="col-xl-12 d-none d-lg-block pb-3">
                    <img className="f-icon" src={cmr} alt="" />
                  </div>
                ...
                <div className="text-lg-center py-lg-3 px-lg-5 me-2">
                  <div className="col-xl-12 d-none d-lg-block pb-3">
                    <FontAwesomeIcon className="f-icon" icon={faPaypal} />
                  </div>
              ...
              <div className="d-lg-flex flex-fill justify-content-evenly">
                <div className="text-lg-center py-lg-3 px-lg-5 me-2">
                  <div className="col-xl-12 d-none d-lg-block pb-3">
                    <FontAwesomeIcon className="f-icon" icon={faCcVisa} />
                  </div>
                  <div className="col-xl-12 col-lg-3 txt-mpagos">Visa</div>
                </div>
                <div className="text-lg-center py-lg-3 px-lg-4 me-2">
                  <div className="col-xl-12 d-none d-lg-block pb-3">
                    <FontAwesomeIcon className="f-icon" icon={faCcMastercard} />
                  </div>
                  <div className="col-xl-12 col-lg-3 txt-mpagos">
                    MasterCard
                  </div>
            ...
            <div className="d-md-flex m-2 flex-fill ">
              <div className="d-lg-flex flex-fill justify-content-evenly">
                <div className="text-lg-center py-lg-3 px-lg-4">
                  <div className="col-xl-12 d-none d-lg-block pb-3">
                    <FontAwesomeIcon className="f-icon" icon={faCcAmex} />
                  </div>
                ...
                <div className="text-lg-center py-lg-3 px-lg-4 ">
                  <div className="col-xl-12 d-none d-lg-block pb-3">
                    <FontAwesomeIcon className="f-icon" icon={faCcDinersClub} />
                  </div>
                  <div className="col-xl-12 col-lg-8 txt-mpagos">
                    Diners Club
                  </div>
              ...
              <div className="d-lg-flex flex-fill justify-content-evenly">
                <div className="text-lg-center py-lg-3 px-lg-4">
                  <div className="col-xl-12 d-none d-lg-block pb-3">
                    <FontAwesomeIcon className="f-icon" icon={faMoneyBill1} />
                  </div>
                  <div className="col-xl-12 col-lg-8 txt-mpagos">
                ...
                <div className="text-lg-center py-lg-3 px-lg-4 ">
                  <div className="col-xl-12 d-none d-lg-block pb-3">
                    <img className="f-icon" src={pefectivo} alt="" />
                  </div>
                  <div className="col-xl-12 col-lg-8 txt-mpagos">
                    Pago Efectivo
                  </div>
        ...
        <div className="row">
          ...
          <div class="col-lg-3 col-sm-12 siguenos">
            <div class="row">
              <div class="medida col-12 col-lg-12 col-md-4 d-flex align-items-center justify-content-center">
                <div class=" col-lg-6 text-lg-center p-3">SIGUENOS</div>
                <div class="col-lg-6 mx-xl-2">
                  <a
              ...
              <div class="col-12 col-lg-12 col-md-8 justify-content-sm-evenly">
                <div class=" my-2 d-lg-block d-md-flex align-items-center">
                  <a href="#" class="d-block text-center">
                    <img class="icon-app my-1" src={GooglePlay} alt="" />
                  </a>
                  <a href="#" class="d-block text-center">
                    <img class="icon-app my-1" src={AppStore} alt="" />
                  </a>
                  <a href="#" class="d-block text-center">
                    <img class="icon-app my-1" src={AppGallery} alt="" />
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="row d-flex justify-content-center my-3">
              <a class="col-12 text-center" target="_blank" href="/#">
                <img class="icon-libro" src={libro} alt="" />
              </a>
              <i class="col-md-12 col-12 mt-3"></i>
